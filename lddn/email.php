...
include_once 'LDDNPro.html';

$VotreAdresseMail="t.guichard0804@gmail.com";//mettez ici votre adresse mail
        ...
        if(!preg_match("#^[a-z0-9_-]+((\.[a-z0-9_-]+){1,})?@[a-z0-9_-]+((\.[a-z0-9_-]+){1,})?\.[a-z]{2,}$#i",$_POST['mail'])){
            ...
            if(empty($_POST['sujet'])) {
                ...
                if(empty($_POST['message'])) {
                    ...
                    $Entetes .= "From: ledepanneurdunumerique.fr<".$_POST['mail'].">\r\n";//de préférence une adresse avec le même domaine de là où, vous utilisez ce code, cela permet un envoie quasi certain jusqu'au destinataire
                    $Entetes .= "Reply-To: ledepanneurdunumerique.fr<".$_POST['mail'].">\r\n";
